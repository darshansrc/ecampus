...
const Navbar = () => {
  ...
  return (
    ...
    <div style={{position: 'fixed' }} ref={scope}>
        <nav class="navbar navbar-expand-lg bg-body-tertiary" style={{borderBottom: '2px solid  #ececf1', padding: '0' ,width: '100%',position: 'fixed',top: '0',backgroundColor: 'rgba(255,255,255,1)',fontFamily: "'Golos Text', sans-serif" ,zIndex: '9999'}} >
