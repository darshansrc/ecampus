...
const StudentMobileNav = () => {
  ...
  return (
	...
	className={ window.location.pathname.endsWith("/course") ? 'active-button' : 'inactive-button'}
	>
		<div class="mobile-bottom-nav__item-content">
			<i class="material-icons"><RiBookMarkLine style={{fontSize: '25px'}}/> </i>
			Course
		</div>
	</NavLink>		
	</div>
	...
	className={ window.location.pathname.endsWith("/marks") ? 'active-button' : 'inactive-button'}
	>
		<div class="mobile-bottom-nav__item-content">
			<i class="material-icons"><TbReport style={{fontSize: '25px'}}/> </i>
			Grades
		</div>
	</NavLink>		
	</div>
